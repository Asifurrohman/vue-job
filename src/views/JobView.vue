<template>
    ...
    <BackButton />
    <div v-if="dataLoaded == false" class="text-center text-gray-500 py-6">
        <PulseLoader />
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
                ...
                <aside>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                        ...
                        <RouterLink :to="`/jobs/edit/${jobId}`" class="bg-green-500 hover:bg-green-600 text-white text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block">
                            Edit Job
                        </RouterLink>
...
const deleteJob = async () => {
    try{
        const confirm = window.confirm('Are you sure about to delete this job?')
        if(confirm){
        ...
        console.log('Failed deleting job', error)
